...
$_['text_search']        = 'Suche';
$_['text_welcome']  = '<li class="login_h"><a href="%s"><i class="icon-file-alt"></i>anmelden</a></li> <li><a href="%s"><i class="icon-lock"></i>erstellen</a></li>';
$_['text_logged']   = '<li class="login_h"><a href="%s"><i class="icon-file-alt"></i>%s</a></li> <li><a href="%s"><i class="icon-lock"></i>Abmelden</a></li>';
